...
## Cel
Dostarczać zmiany, które poprawiają architekturę warstwową, testowalność i stabilność integracji `thessla_green_modbus`.

## Zasady nadrzędne
- Nie optymalizować pod liczbę plików, tylko pod odpowiedzialność modułów.
- Utrzymywać kompatybilność funkcjonalną i pokrywać zmiany testami zachowania.
- Unikać dużych PR-ów; preferować małe, etapowe zmiany.
...
- Uspójniać nazwy, typing i importy, jeśli poprawia to architekturę.

## Czego nie wolno robić
- Dodawać nowych shimów migracyjnych.
- Zmieniać semantyki rejestrów bez walidacji i testów.
- Dodawać importów HA do warstw non-HA.
- Dodawać direct Modbus I/O w coordinatorze/platformach.
...
- 500–700: wymaga spójnej odpowiedzialności.
