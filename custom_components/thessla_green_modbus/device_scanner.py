...
class ThesslaDeviceScanner:
    """Skaner rejestrów – kompatybilny z pymodbus 3.5.*+."""
    ...
    async def scan(self) -> Tuple[DeviceInfo, DeviceCapabilities, Dict[str, Tuple[int, int]]]:
        ...
        try:
            ...
            # Podstawowe informacje (wersje FW) – INPUT 0x0000..0x0016
            ...
            # Discrete inputs – np. expansion, presostat
