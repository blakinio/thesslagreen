...
SET_AIRFLOW_SCHEDULE_SCHEMA = vol.Schema({
    vol.Required("entity_id"): cv.entity_ids,
    vol.Required("day"): vol.In(["monday", "tuesday", "wednesday", "thursday", 
...
SET_BYPASS_PARAMETERS_SCHEMA = vol.Schema({
    ...
    vol.Optional("temperature_threshold"): vol.All(vol.Coerce(float), vol.Range(min=18.0, max=30.0)),
...
RESET_FILTERS_SCHEMA = vol.Schema({
    vol.Required("entity_id"): cv.entity_ids,
    vol.Required("filter_type"): vol.In(["presostat", "flat_filters", "cleanpad", "cleanpad_pure"]),
})
...
SET_MODBUS_PARAMETERS_SCHEMA = vol.Schema({
    ...
    vol.Optional("baud_rate"): vol.In(["4800", "9600", "14400", "19200", "28800", "38400", "57600", "76800", "115200"]),
...
async def async_setup_services(hass: HomeAssistant) -> None:
        ...
        for entity_id in entity_ids:
            ...
            if coordinator:
                ...
                if max_supply_temp is not None:
                    await coordinator.async_write_register("max_supply_temperature", max_supply_temp)
                
                if min_supply_temp is not None:
                    await coordinator.async_write_register("min_supply_temperature", min_supply_temp)
    ...
    async def set_modbus_parameters(call: ServiceCall) -> None:
        ...
        baud_map = {"4800": 0, "9600": 1, "14400": 2, "19200": 3, "28800": 4, 
                    "38400": 5, "57600": 6, "76800": 7, "115200": 8}
...
async def async_unload_services(hass: HomeAssistant) -> None:
    ...
    services = [
        "set_special_mode", "set_airflow_schedule", "set_bypass_parameters", "set_gwc_parameters",
        "set_air_quality_thresholds", "set_temperature_curve", "reset_filters", "reset_settings",
        "start_pressure_test", "set_modbus_parameters", "set_device_name", "refresh_device_data"
    ]
