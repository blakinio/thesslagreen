...
from .utils import _decode_bcd_time, BCD_TIME_PREFIXES, TIME_REGISTER_PREFIXES
from .loader import load_register_definitions
...
class ThesslaGreenDeviceScanner:
    ...
    async def _load_registers(
        ...
        return await asyncio.to_thread(load_register_definitions)
